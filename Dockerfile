...
RUN sed -i "s:# Load configuration files for the default server block.:ignore_invalid_headers off; underscores_in_headers on;:"  /etc/opt/rh/rh-nginx112/nginx/nginx.conf
